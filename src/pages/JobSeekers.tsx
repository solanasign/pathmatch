        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg p-0 md:p-0 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <label className="flex items-center text-gray-700 cursor-pointer">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828L18 9.828M7 7h.01" />
              </svg>
              Attach Resume
              <input
                type="file"
          ...
          <div className="mt-6 flex flex-col items-center">
            ...
            <p className="text-xs text-zinc-600 text-center mt-4">
              ...
              <Link to="https://policies.google.com/privacy" className="underline hover:text-red-600">Privacy Policy</Link>{' '}
              and{' '}
              <Link to="https://policies.google.com/terms" className="underline hover:text-red-600">Terms of Service</Link>{' '}
              apply.
            </p>
          </div>
        </form>
      ...
      <section className="job-seekers-directory w-full mt-16">
        ...
        <div className="directory-hero bg-red-50 py-10">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4">Job Seekers</h1>
